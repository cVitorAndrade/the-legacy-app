        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-md border min-h-10 h-auto items-center justify-between !bg-red0 hover:!bg-inherit [&_svg]:pointer-events-auto",
                ...
                <div className="flex justify-between items-center w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      aria-label={`Desmarcar todas ${selectedValues.length} opções selecionadas`}
          ...
          >
            <Command>
              {searchable && (
                <CommandInput
                  placeholder="Pesqusiar Habilidades..."
